...
String.prototype.grammarPolice = function() {
  return this.split(' ').map(str => str.charAt(0).toLocaleUpperCase() + str.substring(1).toLocaleLowerCase()).join(' ');
}
...
function valueType(arg1, arg2) {
  return arg1 === arg2 ? "Exactly the same" : arg1 == arg2 ? "Same value, different types" : "Different values";
}
